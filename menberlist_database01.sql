...
CREATE TABLE `file table` (
  `No` int(6) NOT NULL,
  `name` char(20) NOT NULL,
  `file first half` text NOT NULL,
  `file second half` text NOT NULL,
...
(19, '$2y$10$opQacFAP.ysg01xo9kajoO0cgrsqmUt5kp99Tn5ZqRnzq/3MtV2Xq', 100001, '荒巻大輔', 'DEV15', '機構', '1234', '登山行きたい！', 'data/img/img_100001.png', '0000-00-00', '2024-07-13 00:44:21', NULL),
